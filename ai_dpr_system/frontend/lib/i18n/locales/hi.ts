...
export default {
  ...
  'Loading...': 'लोड हो रहा है...',
  'DPR-AI': 'डीपीआर-एआई',
  'AI-Powered DPR Risk Assessment': 'एआई-संचालित डीपीआर जोखिम मूल्यांकन',
  'Evaluate infrastructure project risks using advanced AI models for better planning and execution': 'बेहतर योजना और क्रियान्वयन के लिए उन्नत एआई मॉडल का उपयोग करके बुनियादी ढांचा परियोजना जोखिमों का मूल्यांकन करें',
  ...
  'Leverage machine learning to identify potential risks in infrastructure projects': 'बुनियादी ढांचा परियोजनाओं में संभावित जोखिमों की पहचान करने के लिए मशीन लर्निंग का लाभ उठाएं',
  'Detailed Reports': 'विस्तृत रिपोर्ट',
  'Generate comprehensive risk assessment reports with mitigation strategies': 'शमन रणनीतियों के साथ व्यापक जोखिम मूल्यांकन रिपोर्ट तैयार करें',
  ...
  'Access the platform in English, Hindi, and Assamese languages': 'प्लेटफॉर्म को अंग्रेजी, हिंदी और असमिया भाषाओं में देखें',
